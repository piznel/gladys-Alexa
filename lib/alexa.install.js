...
module.exports = function install() {
  ...
  function createParam(id) {
    ...
    var param_lib = {
      ...
      type: 'hidden',
      module: id,
      description: 'library for Alexa. It is used to emulate wemo\'s device'
    }
    ...
    .then(() => {
      ...
      .then(() => {
      return gladys.utils.sql(queries.updateIdParamAlexaLib, [param_lib.module])
    })
    .then((data) => {
      return data
    })
      .catch(() => {
        return gladys.param.setValue(param_lib)
      })
  }
